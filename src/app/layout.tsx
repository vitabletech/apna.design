...
export const metadata: Metadata = {
  ...
  keywords: ["Visual Communication Designer", "APNA DESIGNER", "APNA DESIGN", "Bihari Designer", "Abhay Kumar Singh", "Brand Identity", "UI/UX Design", "Product Design", "Website Design", "Bihar Designer", "Patna Designer"],
